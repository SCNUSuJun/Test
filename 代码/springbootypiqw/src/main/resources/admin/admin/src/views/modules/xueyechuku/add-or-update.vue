<template>
	<div class="addEdit-block" :style='{"padding":"30px","backgroundAttachment":"fixed","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230312/52c1bcab43064c72aa492e0f342d2666.jpg)","flexDirection":"row-reverse","display":"flex","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="血库编号" prop="xuekubianhao">
					<el-input v-model="ruleForm.xuekubianhao" placeholder="血库编号" clearable  :readonly="ro.xuekubianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="血库编号" prop="xuekubianhao">
					<el-input v-model="ruleForm.xuekubianhao" placeholder="血库编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="血型" prop="xuexing">
					<el-input v-model="ruleForm.xuexing" placeholder="血型" clearable  :readonly="ro.xuexing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="血型" prop="xuexing">
					<el-input v-model="ruleForm.xuexing" placeholder="血型" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="袋数" prop="daishu">
					<el-input v-model="ruleForm.daishu" placeholder="袋数" clearable  :readonly="ro.daishu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="袋数" prop="daishu">
					<el-input v-model="ruleForm.daishu" placeholder="袋数" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="出库日期" prop="chukuriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.chukuriqi" label="出库日期" prop="chukuriqi">
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ro.daishu = false;

				this.ruleForm.xueliang = 0
				this.ro.xueliang = false;
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.daishu = objcross.daishu - this.ruleForm.daishu
	      if(objcross.daishu<0){
		this.$message.error("袋数不足");
		return
	      }
                }
      var table = this.$storage.getObj('crossTable');
      if(objcross!=null) {
	      objcross.xueliang = objcross.xueliang - this.ruleForm.xueliang
	      if(objcross.xueliang<0){
		this.$message.error("血量不足");
		return
	      }
                }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xueyechuku/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xueyechukuCrossAddOrUpdateFlag = false;
						 this.parent.search();
