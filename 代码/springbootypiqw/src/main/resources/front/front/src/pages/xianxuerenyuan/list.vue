...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"border":"2px solid #a4d9b7","padding":"10px 0","margin":"10px 0 0 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto"}'>
      <el-form-item :style='{"margin":"10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","color":"#29292a","display":"inline-block"}'>献血编号</div>
        <el-input v-model="formSearch.xianxuebianhao" placeholder="献血编号" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","color":"#29292a","display":"inline-block"}'>献血姓名</div>
        <el-input v-model="formSearch.xianxuexingming" placeholder="献血姓名" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"10px"}'>
		<div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","color":"#29292a","display":"inline-block"}'>血型</div>
        <el-select v-model="formSearch.xuexing" placeholder="请选择血型" :clearable="true">
          <el-option v-for="(item, index) in xuexingOptions" :key="index" :label="item" :value="item"></el-option>
        </el-select>
      </el-form-item>
	  ...
	  <el-button v-if="isAuth('xianxuerenyuan','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"10px","outline":"none","color":"#fff","borderRadius":"10px","background":"#55b44b","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/xianxuerenyuanAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        let searchWhere = {};
        if (this.formSearch.xianxuebianhao != '') searchWhere.xianxuebianhao = '%' + this.formSearch.xianxuebianhao + '%';
        if (this.formSearch.xianxuexingming != '') searchWhere.xianxuexingming = '%' + this.formSearch.xianxuexingming + '%';
        if (this.formSearch.xuexing != '') searchWhere.xuexing = this.formSearch.xuexing;
        this.$http.get('xianxuerenyuan/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/xianxuerenyuanDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
